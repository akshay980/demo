...
function RegisterRoutes() {
    return {
        customRoutes: [
            ...
            {route: 'timesheets', template: 'timesheets', controller: 'timesheets'}
        ], //customRoutes finds template inside app/modules
        easyRoutes: ['organizations', 'users', 'groups', 'categories', 'tasks','timesheets'], // Provide the names of your tables here and make a copy of app/modules/tasks with the same name
